...
Yahoo Labs Webscope ReadMe

The data included herein is provided as part of the Yahoo Labs Webscope program for use solely under the terms of a signed Yahoo Data Sharing Agreement.

Any publication using this data should attribute Yahoo, ideally in the bibliography of the paper, unless Yahoo explicitly requests no attribution. Please include the phrase Yahoo Labs Webscope, the web address https://labs.yahoo.com/outreach and the name of the specific dataset used, including version number if applicable. For example:

Yahoo Labs Webscope ydata-search-novelty-based-answers-ranking-v1_0
